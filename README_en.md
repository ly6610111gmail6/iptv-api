...
| m3u_epg_url              | Full EPG URL used in the M3U header; leave empty to use the EPG URL generated by the application.                                                                                                                                                                                                                                            |                                          |
...
| open_subscribe_headers_to_channels | Enable passing request headers configured on subscription URLs to channel speed tests and M3U results; when disabled, the headers are only used to fetch subscription content.                                                                                                                                                                  | True                                     |
